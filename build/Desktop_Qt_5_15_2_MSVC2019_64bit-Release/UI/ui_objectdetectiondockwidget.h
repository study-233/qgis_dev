/********************************************************************************
** Form generated from reading UI file 'objectdetectiondockwidget.ui'
**
...
#ifndef UI_OBJECTDETECTIONDOCKWIDGET_H
#define UI_OBJECTDETECTIONDOCKWIDGET_H
...
class Ui_ObjectDetectionDockWidget
{
public:
    ...
    void setupUi(QDockWidget *ObjectDetectionDockWidget)
    {
        if (ObjectDetectionDockWidget->objectName().isEmpty())
            ObjectDetectionDockWidget->setObjectName(QString::fromUtf8("ObjectDetectionDockWidget"));
        ObjectDetectionDockWidget->resize(590, 600);
        ObjectDetectionDockWidget->setMinimumSize(QSize(590, 600));
        ...
        ObjectDetectionDockWidget->setWidget(dockWidgetContents);

        retranslateUi(ObjectDetectionDockWidget);

        QMetaObject::connectSlotsByName(ObjectDetectionDockWidget);
    } // setupUi

    void retranslateUi(QDockWidget *ObjectDetectionDockWidget)
    {
...
namespace Ui {
    class ObjectDetectionDockWidget: public Ui_ObjectDetectionDockWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_OBJECTDETECTIONDOCKWIDGET_H
